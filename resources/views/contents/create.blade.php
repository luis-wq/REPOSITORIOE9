...
@section('content')
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img id="img1" class="d-block w-100" src="#" onerror="this.src='../images/default.jpg'" style="width: 100%; height: 300px" alt="First slide">
    </div>
    <div class="carousel-item">
      <img id="img2" class="d-block w-100" src="#" onerror="this.src='../images/default.jpg'" style="width: 100%; height: 300px" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img id="img3" class="d-block w-100" src="#" onerror="this.src='../images/default.jpg'" style="width: 100%; height: 300px" alt="Second slide">
    </div>
  </div>
    ...
    @csrf
     <div class="row">
      <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <select id="seccion" name="seccion" class="form-control{{ $errors->has('seccion') ? ' is-invalid' : '' }}">
              <option value="">Selecciona una opción</option>
                @foreach(App\Permiso::where('id_user',Auth::user()->id)->get() as $permiso)
                  <option value="{{$permiso->id_section}}">{{@App\Section::where('id',$permiso->id_section)->get()->first()->titulo}}</option>
                @endforeach
            </select>
            </div>
        </div>
